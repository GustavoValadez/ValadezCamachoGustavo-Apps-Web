namespace PS2Cafeteria.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CoffeeName = c.String(maxLength: 30),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Client = c.String(maxLength: 30),
                        CoffeeId = c.Int(nullable: false),
                        Quantity = c.Int(nullable: false),
                        Total = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Status = c.String(maxLength: 14),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "CoffeeId", "dbo.Coffees");
            ...
            DropIndex("dbo.Orders", new[] { "CoffeeId" });
